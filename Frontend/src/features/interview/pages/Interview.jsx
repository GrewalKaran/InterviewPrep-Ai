...
const Interview = () => {
  ...
  const { report, getReportById, loading, getResumePdf, resumeDownloading } = useInterview();
  ...
  if (loading || !report) {
    ...
    if (resumeDownloading) {
      return (
        <main className="loading-screen">
          <h1>Waiting for downloading to start...</h1>
        </main>
      );
    }
    ...
    <div className="interview-page">
      <div className="interview-layout">
        ...
        <nav className="interview-nav">
          <button className="previous-page-btn" onClick={()=>{navigate('/')}}>
            ← Previous Page
          </button>
